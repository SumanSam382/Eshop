...
<div id="registration">
 ...
 <form id="RegisterUserForm" action="insert2.jsp" onsubmit="return func(this)" name="f1" method="get">
 	<fieldset>
        <p>
             <label>ID</label>
         ...
         <p>
           ...
           <label for="name"></label>
           <input id="name" name="tel" type="textArea" class="text" value="" />
         ...
         <p>
             <label>PID</label>
             <label for="name"></label>
            <input id="name" name="email" type="textArea" class="text" value="" />
        
         </p>
        <p>
            <p id="new1"></p>
         </p>
            <a href="resistrationad1.jsp"></a>
        <p>
            <label>RS</label>
            <label for="name"></label>
         ...
         <p>
            <button  type="submit" action="func()">ADD FLOWER</button>
         </p>
